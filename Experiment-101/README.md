...
int main(void) {
    printf("Hello World!!!\n");
    printf("Name:Madhavan R\n");
    printf("Regisgter Number: 212223060142\n");
    return 0;
}
```
## Output
<img width="1428" height="278" alt="image" src="https://github.com/user-attachments/assets/f37c4be1-cb3a-42dc-bffe-639fc322ef99" />
