...
int main(void) {
	...
	puts("Name : Madhavan R");
	puts("Register Number : 212223060142");
	return EXIT_SUCCESS;
}
```
## Output
<img width="1413" height="280" alt="image" src="https://github.com/user-attachments/assets/fd80cf54-daef-4920-b50e-d94fe1d4e75b" />
